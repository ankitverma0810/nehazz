...
class ThumbnailBehavior extends ModelBehavior {
    public $_defaults = array('label' => 'thumbnail', //attachment field name in the form//
                              ...
                              'fields' => array('filename' => 'thumbnail'),
    ...
    public function beforeDelete(Model $model, $cascade = true) {
        ...
        $this->_deleteAttachments($model, $model->data[$model->name]['thumbnail']);
        return true;
    }
